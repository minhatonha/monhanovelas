...
function withCORS(headers, request) {
  ...
  const allowedOrigins = ['https://playervipmaster.com', 'https://another-allowed-site.com'];
  
  // Obtém a origem do pedido
  ...
  if (allowedOrigins.includes(origin)) {
    ...
    // Se a origem não estiver permitida, não define o cabeçalho
    headers['access-control-allow-origin'] = 'null'; // ou você pode omitir este cabeçalho
  }
