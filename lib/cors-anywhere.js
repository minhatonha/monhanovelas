...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    originWhitelist: ['https://playervipmaster.com'],            // If non-empty, requests not from an origin in this list will be blocked.
  ...
  if (req.method === 'OPTIONS') {
    // Pre-flight request. Reply successfully if origin is whitelisted:
    if (corsAnywhere.originWhitelist.indexOf(req.headers.origin) !== -1) {
