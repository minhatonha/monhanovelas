...
function withCORS(headers, request) {
  const allowedOrigins = [
    ...
    // Adicione mais URLs permitidas conforme necessário
  ];
  ...
  if (allowedOrigins.includes(origin)) {
    ...
    // Defina um comportamento padrão para origens não permitidas, por exemplo:
    headers['access-control-allow-origin'] = 'null';
    // Ou lança um erro para negar o acesso
